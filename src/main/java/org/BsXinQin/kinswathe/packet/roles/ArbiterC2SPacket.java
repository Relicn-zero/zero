...
public record ArbiterC2SPacket() implements CustomPayload {
...
public static final PacketCodec<PacketByteBuf, ArbiterC2SPacket> CODEC = PacketCodec.unit(new ArbiterC2SPacket());
