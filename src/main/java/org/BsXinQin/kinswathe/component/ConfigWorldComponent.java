...
public class ConfigWorldComponent implements AutoSyncedComponent, ServerTickingComponent {
    ...
    public void writeToNbt(@NotNull NbtCompound tag, RegistryWrapper.@NotNull WrapperLookup registryLookup) {
        ...
        ArbiterAbilityPrice = KinsWatheConfig.HANDLER.instance().ArbiterAbilityPrice;
        tag.putInt("ArbiterAbilityPrice", this.ArbiterAbilityPrice);
        ArbiterGlowDuration = KinsWatheConfig.HANDLER.instance().ArbiterGlowDuration;
